...
- changed software architecture. bmsctrl and sysctrl modules have renamed and redefined. Now SYS starts the other state machines. BMS implements the application and makes request to ILCK. Error counting with threshold is now made with DIAG.
